          ...
          <Row justify="center">
            <Col span={18}>
                    ...
                    <Row justify="start">
                        <Col span ={4}>
                            <Row align="middle" justify="start">
                                <Col>
                                    <div style={{ marginLeft: "0%" }}>{logo_vaga}</div>
                                </Col>
                            </Row>
                        </Col>
                        <Col span ={16}>
                            Nome da vaga, Tags, Nome Empresa, Local
                        </Col>
                        <Col span ={4}>
                            <Row align="middle">
                                <Col>
                                    <Button type="primary" style={{ marginRight: "0%", marginTop: "0%" }}>Candidatar-se</Button>
                                </Col>
                            </Row>
                        </Col>
                    </Row>
                ...
                <Row>
                    ...
                    <div style={{ justifyContent: "center", marginLeft: "4%", marginTop: "1%" }}>
                    <Row justify="start">
                        Porte e quantidade de funcionarios
                    </Row>
                    <Row justify="start">
