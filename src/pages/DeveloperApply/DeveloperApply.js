              ...
              <div style={{ justifyContent: "center", marginLeft: "4%", marginTop: "1%" }}>
                <Row justify="start">
                  <Col span={15}>
                    <Typography.Title level={3} style={{ marginBottom: 0 }}>
                      Confirme os dados da sua Incrição
                    </Typography.Title>
                  </Col>
                </Row>
                <Row justify="start" style={{marginTop:"1%"}}>
                  <Col span={8}>
                    ...
                    >
                      <Form.Item
                        ...
                        rules={
                          [
                            { required: true, message: "Insira sua localidade" },
                          ]
                        }
                      >
                        <Input placeholder="insira sua localidade" />
                      </Form.Item>
                    </Form>
                  </Col>
                  <Col span={8}>
                    ...
                    >
                      <Form.Item
                        ...
                        rules={
                          [
                            { required: true, message: "Selecione seu nível de escolaridade" },
                          ]
                        }
                      >
                        <Select
                        ...
                        >
                          ...
                          <Select.Option value="medio">Ensino Médio</Select.Option>
                          <Select.Option value="graduado">Graduado</Select.Option>
                          <Select.Option value="mestrado">Mestrado</Select.Option>
                          <Select.Option value="doutorado">Doutorado</Select.Option>
                        </Select>
                      </Form.Item>
                  ...
                  <Col span={8}>
                    ...
                    >
                      ...
                      >
                        <Input placeholder="insira o nome do curso realizado" />
                      </Form.Item>
                ...
                <Row justify="start" style={{marginTop:"1%"}}>
                  <Col span={8}>
                    ...
                    >
                      <Form.Item
                        ...
                        rules={
                          [
                            { required: true, message: "Insira sua instituição de ensino" },
                          ]
                        }
                      >
                  ...
                  <Col span={8}>
                    ...
                    >
                      <Form.Item
                        label="Empresas onde trabalhou"
                        name="Empresas onde trabalhou"
                        style={{ width: "80%" }}
                        rules={
                          [
                            // { required: true, message: "Please input your username!" },
                      ...
                      >
                        <Input placeholder="insira o nome das empresas" />
                      </Form.Item>
                  ...
                  <Col span={8}>
                    ...
                    >
                      <Form.Item
                        label="Cargos onde já atuou"
                        name="Cargos onde já atuou"
                        style={{ width: "80%" }}
                        rules={
                          [
                            // { required: true, message: "Please input your username!" },
                      ...
                      >
                        <Input placeholder="insira o nome do cargo" />
                      </Form.Item>
                ...
                <Row justify="start" style={{marginTop:"1%"}}>
                  <Col span={8}>
                    ...
                    >
                      <Form.Item
                        label="Tecnologias que você possui experiência"
                        name="Email"
                        style={{ width: "80%" }}
                        rules={
                          [
                            { required: true, message: "Insira as tecnologias" },
                          ]
                        }
                      >
                  ...
                  <Col span={8}>
                    ...
                    >
                      <Form.Item
                        ...
                        rules={
                          [
                            { required: true, message: "insira o nome do seu usuário no Linkedin" },
                          ]
                        }
                      >
                        <Input placeholder="insira o nome de seu usuário no Linkedin" />
                      </Form.Item>
                  ...
                  <Col span={8}>
                    ...
                    >
                      <Form.Item
                        ...
                        rules={
                          [
                            { required: true, message: "insira o nome do seu usuário no Github" },
                          ]
                        }
                      >
                        <Input placeholder="insira o nome do seu usuário no Github" />
                      </Form.Item>
                ...
                <Row justify="start" style={{marginTop:"1%"}}>
                  <Col span={8}>
                    ...
                    >
                      <Form.Item
                        label="Faça upload do seu currículo"
                        name="Faça upload do seu currículo"
                        style={{ width: "80%" }}
                        rules={
                          [
                            { required: true, message: "faça upload do seu currículo" },
                          ]
                        }
                      >
                        <Upload
                          ...
                          onChange={{}}
                        >
                          <Button icon={<UploadOutlined />}>Enviar Currículo</Button>
                        </Upload>
                      </Form.Item>
                    </Form>
                  </Col>
                  ...
                  <Col span={8}>
                    ...
                    >
                      ...
                      >
                        <Input placeholder="insira seu celular com DDD" />
                      </Form.Item>
                ...
                <Row justify="start" style={{marginTop:"1%"}}>
                  <Col span={12}>
                    ...
                    >
                      <Form.Item
                        label="Receber informações sobre o processo seletivo por"
                        name="Receber informações sobre o processo seletivo por"
                        style={{ width: "80%" }}
                        rules={
                          [
                            // { required: true, message: "faça upload do seu currículo" },
